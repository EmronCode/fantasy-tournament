...
# Match 1 (LavaBolt vs SpaceRock)
play(LavaBolt, SpaceRock)

# Match 2 (FrostHammer vs JungleTorch)
play(FrostHammer, JungleTorch)

# Match 3 Loser's Bracket (SpaceRock vs JungleTorch)
play(SpaceRock, JungleTorch)

# Match 4 Finals (LavaBolt vs FrostHammer)
